  ...
  <div class="h-full flex flex-col bg-slate-50 relative overflow-hidden">
    ...
    <header class="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between shrink-0 relative z-10">
      <div class="flex items-center gap-4">
        <div @click="$router.push('/mirror_dashboard')" class="bg-green-100 p-2 rounded-lg cursor-pointer hover:bg-green-200 transition">
          <i class="fa-solid fa-arrow-right-arrow-left text-green-600 text-xl"></i>
        </div>
        <div>
           <h1 class="text-xl font-bold text-slate-800">会計ソフトデータ変換 (Mirror)</h1>
...
// Import from Mirror World Composable
import { Mirror_useDataConversion } from '@/Mirror_sandbox/Mirror_composables/Mirror_useDataConversion';

const router = useRouter();

// [Internal_Logic_Flow] Line:207
const { logs, addLog, markAsDownloaded } = Mirror_useDataConversion();
