  ...
  <div class="h-screen flex flex-col bg-slate-100 font-sans overflow-hidden">
    ...
    <header class="bg-white border-b border-slate-200 h-14 flex items-center justify-between px-4 shrink-0 z-20">
      <div class="flex items-center gap-4">
        <button @click="$router.push('/mirror_dashboard')" class="text-slate-500 hover:text-slate-800 transition-colors">
...
import { Mirror_useJournalEditor } from '@/Mirror_sandbox/Mirror_composables/Mirror_useJournalEditor';
