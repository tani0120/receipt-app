...
import { JournalService } from '@/Mirror_sandbox/Mirror_services/Mirror_JournalService';
import type { JournalEntry, JournalLine, ValidationResult } from '@/Mirror_sandbox/Mirror_types/Mirror_journal';

export function Mirror_useJournalEditor() {
