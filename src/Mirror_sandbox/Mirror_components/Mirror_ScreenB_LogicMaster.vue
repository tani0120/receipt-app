...
import { Mirror_useAccountingSystem, ClientActionType } from '@/Mirror_sandbox/Mirror_composables/Mirror_useAccountingSystem';

const router = useRouter();
const { clients, jobs, subscribeToAllJobs, fetchClients } = Mirror_useAccountingSystem();
