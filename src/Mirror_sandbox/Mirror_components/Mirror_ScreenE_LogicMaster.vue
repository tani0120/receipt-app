...
import { Mirror_useAccountingSystem, type Job, type JobStatus } from '@/Mirror_sandbox/Mirror_composables/Mirror_useAccountingSystem';
import { Timestamp } from 'firebase/firestore';

const route = useRoute();
const router = useRouter();
const { jobs, getClientByCode, updateJobStatus } = Mirror_useAccountingSystem();
