...
export const leadFieldsFlat: FieldDef[] = [
  ...
  // progressLink は見込先では不要（顧問先のみ）
  { key: 'leadId', label: '内部ID', section: '', component: 'readonly', widthPercent: 20, order: 10, alwaysReadonly: true, cssClass: 'ce-muted' },
  ...
  { key: 'sharedEmail', label: '見込先ログインメール（自動取得）', section: '', component: 'readonly', widthPercent: 20, order: 43, alwaysReadonly: true, hint: '※編集不可' },
  { key: 'uploadUrlStaff', label: '社内用アップロードURL（自動）', section: '', component: 'url', widthPercent: 20, order: 44, alwaysReadonly: true },
  { key: 'uploadUrlGuest', label: '見込先用アップロードURL（自動）', section: '', component: 'url', widthPercent: 20, order: 45, alwaysReadonly: true },
