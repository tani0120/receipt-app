    ...
    <div class="max-w-6xl mx-auto w-full">
      ...
      <div class="grid grid-cols-12 gap-8">
          ...
          <div class="col-span-8 grid grid-cols-2 gap-6">
              ...
              <div @click="$router.push('/dashboard');" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition cursor-pointer group hover:-translate-y-1">
