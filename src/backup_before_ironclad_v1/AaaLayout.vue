...
import { aaa_useAccountingSystem as useAccountingSystem } from '@/composables/useAccountingSystem';
import { seedRichJobs } from '@/utils/seedRichJobs';
import { aaa_useDataConversion as useDataConversion } from '@/composables/useDataConversion';
...
const isAaa = computed(() => route.path.startsWith('/'));

const getPath = (key: string) => {
    // Force aaa prefix for this layout
    switch (key) {
        case 'A': return '/clients';
        case 'B': return '/journal-status';
        case 'C': return '/collection-status';
        case 'D': return '/ai-rules';
        case 'G': return '/data-conversion';
        case 'H': return '/task-dashboard';
