          ...
          <div class="step">
            ...
            <div class="step-body">
              ...
              <div class="url-group">
                ...
                <div class="url-entry">
                  <span class="url-entry-label">アップロードURL（PC・スマホ共通）：</span>
                  <div class="url-row">
                    <input class="url-input" :value="staffUrl" readonly @click="selectAll" />
                    <button class="copy-btn" :class="{ 'copy-btn--copied': copiedKey === 'staff' }" @click="copyText(staffUrl, 'staff')">
                      <span class="copy-icon" :class="{ 'copy-icon--pop': copiedKey === 'staff' }">📋</span>
                      <span v-if="copiedKey === 'staff'" class="copy-toast">コピー済</span>
                    </button>
                  </div>
                </div>
              </div>
