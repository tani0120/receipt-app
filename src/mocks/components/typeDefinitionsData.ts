...
export const TYPE_SECTIONS: TypeSection[] = [
  {
    ...
    fields: [
      ...
      { field: 'fileHash', label: 'SHA-256', tsType: 'string | null', uploadOwn: '✅', uploadDrive: '🔧', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: 'Drive側はmigrate後に後付け可能' },
  ...
  },
  {
    ...
    fields: [
      { field: 'date', label: '日付', tsType: 'string | null', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '✅', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: 'Drive: フェーズ3.5で対応予定' },
      { field: 'amount', label: '金額', tsType: 'number | null', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '✅', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: '' },
      { field: 'vendor', label: '取引先', tsType: 'string | null', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '✅', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: '' },
      { field: 'source_type', label: '証票種別', tsType: 'SourceType', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: '' },
      { field: 'direction', label: '仕訳方向', tsType: 'Direction', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '✅', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: '' },
      { field: 'description', label: '摘要', tsType: 'string | null', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '✅', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: '' },
      { field: 'classify_reason', label: '判定根拠', tsType: 'string | null', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: '' },
      { field: 'supplementary', label: '補助資料', tsType: 'boolean', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: '' },
      { field: 'confidence', label: '信頼度(2種)', tsType: 'number', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: '' },
      { field: 'processing_mode', label: '処理モード', tsType: 'string', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: '→ DocEntry.aiProcessingMode' },
      { field: 'fallback', label: 'フォールバック', tsType: 'boolean', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: '→ DocEntry.aiFallbackApplied' },
      { field: 'warning', label: '警告', tsType: 'string | null', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: '→ DocEntry.aiWarning' },
      { field: 'isDuplicate', label: '重複フラグ', tsType: 'boolean', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '🔧', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: 'fileHashで代替可能だが未実装' },
      { field: 'document_count', label: '証票枚数', tsType: 'number', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: 'UploadEntry.documentCount → DocEntry.aiDocumentCount' },
    ],
  },
  {
    title: 'C. 行データ（line_items）', icon: 'fa-solid fa-list-ol',
    fields: [
      { field: 'lineItems[]', label: '行データ配列', tsType: 'Array', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '将来', outMf: '✅', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: '' },
      { field: 'lineItemsCount', label: '行数', tsType: 'number', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '将来', outMf: '—', outCost: '—', outStaffCount: '✅', outStaffTime: '—', note: '' },
    ],
  },
  {
    title: 'D. メトリクス（処理性能・費用）', icon: 'fa-solid fa-chart-bar',
    fields: [
      { field: 'duration_ms', label: '処理時間', tsType: 'number', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '将来', outMf: '—', outCost: '✅', outStaffCount: '—', outStaffTime: '✅', note: '' },
      { field: 'tokens(3種)', label: 'トークン数', tsType: 'number', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '将来', outMf: '—', outCost: '✅', outStaffCount: '—', outStaffTime: '—', note: '' },
      { field: 'cost_yen', label: '利用料(円)', tsType: 'number', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '将来', outMf: '—', outCost: '✅', outStaffCount: '—', outStaffTime: '—', note: '' },
      { field: 'model', label: 'AIモデル', tsType: 'string', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '将来', outMf: '—', outCost: '✅', outStaffCount: '—', outStaffTime: '—', note: '' },
      { field: 'size_kb(2種)', label: 'サイズ(KB)', tsType: 'number', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '🔧', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: 'DocEntryマッピング未実装' },
      { field: 'reduction_pct', label: '削減率(%)', tsType: 'number', uploadOwn: '✅', uploadDrive: '⛔', selectOwn: '🔧', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: '同上' },
    ],
  },
  {
    ...
    fields: [
      ...
      { field: 'createdBy', label: '操作者', tsType: 'string | null', uploadOwn: '⛔', uploadDrive: '⛔', selectOwn: '✅', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '✅', outStaffTime: '✅', note: '同上。Drive: ログインユーザーID付与で対応可能' },
      { field: 'updatedBy', label: '最終更新者', tsType: 'string | null', uploadOwn: '⛔', uploadDrive: '⛔', selectOwn: '🔧', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: 'アップロード時に更新は物理的に未発生' },
  ...
  },
  {
    ...
    fields: [
      ...
      { field: 'statusChangedBy', label: '選別操作者', tsType: 'string | null', uploadOwn: '⛔', uploadDrive: '⛔', selectOwn: '🔧', selectDrive: '🔧', prodAi: '—', outMf: '—', outCost: '—', outStaffCount: '—', outStaffTime: '—', note: 'アップロード時点では選別未実施' },
