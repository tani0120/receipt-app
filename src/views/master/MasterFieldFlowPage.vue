...
const fieldSections: { title: string; note: string; hasMf: boolean; hasMaster: boolean; rows: FieldRow[] }[] = [
  {
    ...
    rows: [
      ...
      { field: 'effectiveFrom',        label: '施行日',                 mf: '❌', master: '✅', validation: '—',  side: 'back',  note: '', highlight: false },
      { field: 'effectiveTo',          label: '廃止日',                 mf: '❌', master: '✅', validation: '—',  side: 'back',  note: '', highlight: false },
      ...
      { field: 'hiddenInMaster',      label: '全社マスタ非表示',       mf: '❌', master: '📊', validation: '—（hidden=trueから導出。全社マスタ画面の表示制御）',  side: 'front', note: '導出値。26箇所以上で使用', highlight: false },
      { field: 'hidden',          label: '非表示フラグ',             mf: '❌', master: '✅', validation: '—',  side: 'back',  note: '', highlight: false },
