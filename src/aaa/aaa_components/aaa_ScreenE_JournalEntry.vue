        ...
        <div class="h-12 flex items-center justify-between px-4">
             <div class="flex items-center gap-4 w-full">
                ...
                <div class="text-xs font-bold flex items-center gap-1 shrink-0 text-gray-500">
                    <button @click="router.push('/aaa_journal-status')" class="hover:underline">全社仕訳 (リンク)</button>
...
function executeBatch() {
    ...
    approvalQueue.value = [];
    router.push(`/aaa_journal-status?client=${currentJob.value?.clientCode || '1001'}`);
}
