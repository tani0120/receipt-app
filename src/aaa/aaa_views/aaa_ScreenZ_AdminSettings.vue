...
import type { RuleCategory, PromptItem } from '@/aaa/aaa_composables/aaa_useAdminDashboard';

// Components
import aaa_ScreenZ_Dashboard from './aaa_ScreenZ/aaa_ScreenZ_Dashboard.vue';
import aaa_ScreenZ_Settings from './aaa_ScreenZ/aaa_ScreenZ_Settings.vue';
import aaa_ScreenZ_Masters from './aaa_ScreenZ/aaa_ScreenZ_Masters.vue';
import aaa_ScreenZ_Rules from './aaa_ScreenZ/aaa_ScreenZ_Rules.vue';
import aaa_ScreenZ_Prompts from './aaa_ScreenZ/aaa_ScreenZ_Prompts.vue';
import aaa_ScreenZ_RuleDetail from './aaa_ScreenZ/aaa_ScreenZ_RuleDetail.vue';
import aaa_ScreenZ_PromptDetail from './aaa_ScreenZ/aaa_ScreenZ_PromptDetail.vue';
import aaa_Z_StaffModal from './aaa_ScreenZ/aaa_Z_StaffModal.vue';
...
const activeComponent = computed(() => {
    switch(currentView.value) {
        case 'settings': return aaa_ScreenZ_Settings;
        case 'masters': return aaa_ScreenZ_Masters;
        case 'rules': return aaa_ScreenZ_Rules;
        case 'prompts': return aaa_ScreenZ_Prompts;
        default: return aaa_ScreenZ_Dashboard;
    }
});
