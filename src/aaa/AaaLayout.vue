...
const isMirror = computed(() => route.path.startsWith('/aaa_'));

const getPath = (key: string) => {
    switch (key) {
        case 'A': return isMirror.value ? '/aaa_clients' : '/clients';
        case 'B': return isMirror.value ? '/aaa_journal-status' : '/journal-status';
        case 'C': return isMirror.value ? '/aaa_collection-status' : '/collection-status';
...
const navigateToAdmin = () => {
    router.push(isMirror.value ? '/aaa_admin-settings' : '/admin-settings');
};
