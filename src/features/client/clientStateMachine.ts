...
export class StateTransitionError extends Error {
    constructor(
        public readonly from: ClientStatus,
        public readonly to: ClientStatus,
 ...
 * - その他すべて
 */
export function assertClientTransition(
    from: ClientStatus,
    to: ClientStatus
): void {
...
/**
 * 状態マシン定義（オプション）
 * 実際の実装ではassertClientTransitionを使用
 */
export const clientStateMachine = {
    id: "client",
