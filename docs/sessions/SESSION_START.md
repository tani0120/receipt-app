...
### **Phase 6.2 - Backend Integration 進行中 ⏳**

**重要な方針転換**: Phase 6.2を3スプリント分割

| スプリント | 内容 | 状態 |
|-----------|------|------|
| **Sprint 6.2-A** | **Gemini OCR安定動作** | **👈 進行中** |
| Sprint 6.2-B | 品質安定化 | ⏸️ 未着手 |
| Sprint 6.2-C | 会計的に使える形 | ⏸️ 未着手 |

**Sprint 6.2-A Done Definition（5つ全て必須）**:
- [ ] べき等性: 10回とも同じJSONが返る
- [ ] Cache Hit率: 9/10回
- [ ] 処理時間: 初回3秒以内、2回目以降1秒以内
- [ ] コスト: 10回で15円以内
- [ ] JSON品質: 必須項目存在、税率妥当、科目妥当
