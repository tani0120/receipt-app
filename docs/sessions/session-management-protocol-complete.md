...
```markdown
【セッション終了プロトコル】
セッション終了時、人間は以下を実行すること：

1. 必読ファイルの更新確認
   人間が指示：「必読ファイル更新の提案をして」
   
   AIが提示する内容：
   - 議論中に修正が必要になったファイルのリスト
   - 各ファイルの修正内容（差分形式）
   - 修正理由（議論の背景、哲学の進化を含む）
   - CHANGELOG.mdへの記載案（標準テンプレート使用）

2. セッション議論要約の確認
   AIが作成した `docs/sessions/SESSION_YYYYMMDD.md` を確認：
   - 決定事項が正しいか
   - 申し送り事項が漏れていないか
   - 哲学・動機が記録されているか

3. セッション開始プロトコルの更新確認
   新規作成したファイルがあればリストに追加：
   - 追加する場合：AIが更新版プロトコルを提示
   - 人間がコピペしてメモ

4. 次回セッション用の指示を準備
   更新されたセッション開始プロトコルをコピーして保存
```
...
**以上、粒度を一切落とさない完全版です。**
# Session Management Protocol - 追加セクション

**こ�Eファイルの冁E��をsession-management-protocol-complete.mdの末尾に追加**
...
### 忁E��作業�E�完�EチェチE��リスト！E

#### 1. ファイル作�E・更新の記録
- [ ] SESSION_YYYYMMDD.md作�E
  - セチE��ョン概要E��目標�E成果�E�E
  - **作�Eファイル完�E一覧**�E�ファイルパス�E�E
  - **更新ファイル一覧**
  - **更新なしファイルの確誁E*
  - git commit記録�E�Eash, メチE��ージ�E�E
  - 確立した設計原剁E�E哲学
  - 次回セチE��ョン忁E��ファイル
  - 次のアクション候裁E

#### 2. メタチE�Eタ更新
- [ ] 今日作�EしたファイルにメタチE�Eタ追加
  ```markdown
  **作�E日**: YYYY-MM-DD  
  **最終更新**: YYYY-MM-DD  
  **スチE�Eタス**: Draft / Active / Frozen / Archived / Deprecated
  ```
...
- [ ] [PROJECT_INDEX.md](file:///C:/Users/kazen/.gemini/antigravity/brain/129dd3c2-bc83-48ac-91da-9736f587788a/PROJECT_INDEX.md)更新
  ...
  - 更新日更新
  - スチE�Eタス更新
- [ ] [SESSION_INDEX.md](file:///c:/Users/kazen/OneDrive/チE��クトッチEai_gogleanti/docs/sessions/SESSION_INDEX.md)更新
  - セチE��ョン一覧に追加
  - 重要セチE��ョンセクションに詳細追加
- [ ] [READING_INDEX.md](file:///C:/Users/kazen/.gemini/antigravity/brain/129dd3c2-bc83-48ac-91da-9736f587788a/READING_INDEX.md)確誁E
  - 新規ADR/タスクを追加
...
- [ ] 古ぁE��ァイルの検�E�E�E週間以上更新なし等！E
- [ ] 廁E��候補�E確誁E
- [ ] ANALYSIS/ARTIFACTファイルのアーカイブ判宁E

#### 6. 重要ADR/哲学の確誁E
- [ ] 今日確立した原剁E��ADRに記録されてぁE��ぁE
- [ ] 忁E��なら追訁E
- [ ] CHANGELOG_SYSTEM_PHILOSOPHY.md更新�E�哲学変更があった場合！E

---

## 4. メタプロトコル�E�ファイル管琁E�Eルール

**最終更新**: 2026-01-16

### ファイル4刁E��E

#### A. PROTOCOL�E�永続�E人間が見る�E�E
```
...
#### C. ANALYSIS�E�一時�E刁E���E�E
```
*-analysis-*.md
*-gap-*.md
*-protocol.md�E��E析用�E�E
```
...
**処琁E��況E*:
1. protocolに重要E��刁E��反映
2. `ARCHIVED_<filename>-YYYYMMDD.md`にリネ�Eム

---

#### D. ARTIFACT�E�一時�E作業用�E�E
```
implementation_plan.md�E�上書きされる�E�E
そ�E他セチE��ョン冁E��業ファイル
```
...
**削除また�Eアーカイブ条件**:
- カチE��リC�E�ENALYSIS�E�E+ protocolに反映済み
- カチE��リD�E�ERTIFACT�E�E+ セチE��ョン完亁E
...
**判定侁E*:
- protocol-gap-analysis.md ↁE**タスク化不要E*�E�EセチE��ョンで完結！E
- Penta-Shield実裁EↁE**タスク化忁E��E*�E�Ehase 1-5、褁E��セチE��ョン�E�E

---

### Protocolへの雁E��E��剁E

**原則**: **すべてはprotocolに雁E��E*

**方況E*:
1. 刁E��ファイル�E�カチE��リC�E�で問題を整琁E
2. session-management-protocol-complete.mdに重要E��刁E��反映
3. 刁E��ファイルを削除また�EアーカイチE

**例夁E*: 
- 詳細すぎる�E容は別ファイル化してprotocolからリンク
- 教科書皁E��ファイル�E�EHASE_X_COMPLETION.md等）�E別ファイルとして保孁E
...
| Active | 使用中、更新中 | 可 |
| Frozen | 確定、更新禁止 | 不可 |
| Archived | 参�E専用、古ぁE��報 | 不可 |
| Deprecated | 廁E��予定、使用禁止 | 不可 |
...
```
READING_INDEX.md�E�忁E��ファイル一覧�E�E
  ├─ session-management-protocol-complete.md�E�このファイル�E�E
  ├─ PROJECT_INDEX.md�E�ファイル網羁E��E
  ├─ SESSION_INDEX.md�E�セチE��ョン一覧�E�E
  └─ task.md�E�タスク管琁E��E
```
...
- **2026-01-16**: セチE��ョン終亁E�Eロトコル、メタプロトコル、ファイル4刁E��、命名規則、メタチE�Eタ標準を追加
---
...
4. 関連ファイルBに「関連ファイルAの更新により最終更新日を更新」と注記（オプション）

**例**:
```markdown
# ADR-004を更新した場合

1. ADR-004の「関連ファイル」を確認
   **関連ファイル**: PHASE_1_COMPLETION.md, ADR-005, ADR-006

2. PHASE_1_COMPLETION.mdの最終更新日を更新
   **最終更新**: 2026-01-15 → 2026-01-17

3. ADR-005, ADR-006の最終更新日も更新
```

**注意**:
- 内容の変更がなくても、最終更新日は更新する
- 関連ファイルが多い場合は、直接的な依存関係のみを更新
...
- **2026-01-16**: セッション終了プロトコル、メタプロトコル、ファイル4分類、命名規則、メタデータ標準を追加
