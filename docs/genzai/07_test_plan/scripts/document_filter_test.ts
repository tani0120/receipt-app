...
const FILE_EXPECTED: Record<string, FileExpected> = {
  ...
  'receipt/receipt_05.jpg':                                        { classification: 'journalable', source_type: 'receipt', direction: 'expense', t_number: 'T6120001018791',  phone: '0723381806', vendor_name: '万代',             vendor_vector: 'supermarket' },
