...
| アイコン | ラベル | 意味 | 色（非選択時）| 色（選択時）|
|---------|-------|------|------------|-----------|
| 📄 | `NEED_DOCUMENT` | 資料が必要 | `text-gray-400` | `text-red-600` |
| ✅ | `NEED_CONFIRM` | 確認が必要 | `text-gray-400` | `text-red-600` |
| 💬 | `NEED_CONSULT` | 相談が必要 | `text-gray-400` | `text-red-600` |
