...
### **全22種類のラベル網羅** ✅（2026-02-23パイプライン対応表準拠に更新）

- 証憑種類（7個）: RECEIPT, INVOICE, TRANSPORT, CREDIT_CARD, BANK_STATEMENT, MEDICAL, NOT_APPLICABLE
- ルール（2個）: RULE_APPLIED, RULE_AVAILABLE
- 制度（3個）: INVOICE_QUALIFIED, INVOICE_NOT_QUALIFIED, MULTI_TAX_RATE
- 警告（10個）: DEBIT_CREDIT_MISMATCH, TAX_CALCULATION_ERROR, MISSING_FIELD, UNREADABLE_FAILED, DUPLICATE_CONFIRMED, MULTIPLE_VOUCHERS, DUPLICATE_SUSPECT, DATE_OUT_OF_RANGE, UNREADABLE_ESTIMATED, MEMO_DETECTED
