...
**予定機能**:
- 複合仕訳の編集（N対N）
- ステータス変更（pending → help/soudan/kakunin）
- メモの追加・編集
- ラベルの追加・削除
...
- [Phase 5 実装ガイド](file:///C:/dev/receipt-app/docs/genzai/04_mock/phase5_implementation_guide_260214.md)
- [Phase 5 UI設計戦略](file:///C:/dev/receipt-app/docs/genzai/04_mock/phase5_ui_design_strategy_260214.md)
