...
プロジェクト全体のセッション記録：
```
C:\dev\receipt-app\docs\sessions\SESSION_YYMMDD_（意味）.md
```
...
### **フォーマット**
参照：`C:\dev\receipt-app\docs\sessions\SESSION_260208_PhaseA概要ドキュメント作成.md`
...
- ✅ **必須**: セッション記録作成（下記フォーマット厳守）

**セッション記録作成手順**:

1. **保存場所**: `C:\dev\receipt-app\docs\sessions\SESSION_YYMMDD_（意味）.md`
...
2. **ファイル命名**:
   ...
   例:
   SESSION_260208_PhaseA概要ドキュメント作成.md
   SESSION_260208_Phase4設計レビュー.md
   ```

3. **参照フォーマット**: `C:\dev\receipt-app\docs\sessions\SESSION_260208_PhaseA概要ドキュメント作成.md`
...
5. **作成タイミング**: セッション終了時、ユーザーが「セッション終了」を指示した後

6. **Gitコミット**: セッション記録作成後、必ずgitコミット
