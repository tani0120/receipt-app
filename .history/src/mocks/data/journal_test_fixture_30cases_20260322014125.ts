...
export const mockJournalsPhase5: JournalPhase5Mock[] = [
  ...
  // 行26: サポート依頼（help）、メモあり、未読
  {
    ...
    invoice_status: null,
    invoice_number: null,
    memo: 'この仕訳が良くわかりません。教えてください。',
    memo_author: '山田太郎',
    memo_target: '佐藤花子',
    memo_created_at: '2025-02-08T10:00:00Z',
    staff_notes: {
      ...createEmptyStaffNotes(),
      NEED_CONSULT: { enabled: true, text: '不明な目が不明です', chatworkUrl: '' }
    },
    staff_notes_author: '山田太郎',
    is_credit_card_payment: false,
    voucher_type: null
  ...
  // 行28: 日付null（on_document=true: 日付欄はあるが読めなかった）、メモあり、未読
  {
    ...
    description: '現金取扱せれ仮手い',
    document_id: 'receipt-001',
    line_id: null,
    status: null,
    is_read: false,
    deleted_at: null,
    labels: ['RECEIPT', 'DATE_UNKNOWN', 'MEMO_DETECTED', 'NEED_DOCUMENT'],  // 日付不明 + 手書きメモ + 書類が不足
    debit_entries: [
  ...
  // 行30: 勘定科目null（on_document=false: 証票に勘定科目の記載なし）、貸借不一致、未読
  {
    id: 'jrn-00000030',
    display_order: 30,
  ...
  // 行31: 1対2複合仕訳（決算整理 → 現金+クレジットカード）
  {
    id: 'jrn-00000031',
    display_order: 31,
    voucher_date: '2025-02-11', date_on_document: true,
    description: 'タクシー代（決算整理）',
    document_id: 'receipt-001',
    line_id: null,
    status: null,
    is_read: true,
  ...
  // 行34: 1対10複合仕訳（決算整理 → 10科目の内訳）
  {
    id: 'jrn-00000034',
    display_order: 34,
    voucher_date: '2025-02-14', date_on_document: true,
    description: '決算整理（貸倒10科目）',
    document_id: 'receipt-001',
    line_id: null,
    status: null,
    is_read: true,
    ...
    labels: ['RECEIPT', 'INVOICE_QUALIFIED'],
    debit_entries: [
      { account: '決算整理', account_on_document: true, sub_account: null, amount: 55000, amount_on_document: true, tax_category_id: '課税仕入 10%' }
    ],
    credit_entries: [
      { account: '現金', account_on_document: true, sub_account: '科目1', amount: 5000, amount_on_document: true, tax_category_id: '対象外' },
      { account: '現金', account_on_document: true, sub_account: '科目2', amount: 5000, amount_on_document: true, tax_category_id: '対象外' },
      { account: '現金', account_on_document: true, sub_account: '科目3', amount: 5000, amount_on_document: true, tax_category_id: '対象外' },
      { account: '現金', account_on_document: true, sub_account: '科目4', amount: 5000, amount_on_document: true, tax_category_id: '対象外' },
      { account: '現金', account_on_document: true, sub_account: '科目5', amount: 5000, amount_on_document: true, tax_category_id: '対象外' },
      { account: '現金', account_on_document: true, sub_account: '科目6', amount: 5000, amount_on_document: true, tax_category_id: '対象外' },
      { account: '現金', account_on_document: true, sub_account: '科目7', amount: 5000, amount_on_document: true, tax_category_id: '対象外' },
      { account: '現金', account_on_document: true, sub_account: '科目8', amount: 5000, amount_on_document: true, tax_category_id: '対象外' },
      { account: '現金', account_on_document: true, sub_account: '科目9', amount: 5000, amount_on_document: true, tax_category_id: '対象外' },
      { account: '現金', account_on_document: true, sub_account: '科目10', amount: 5000, amount_on_document: true, tax_category_id: '対象外' }
    ],
    rule_id: null,
    rule_confidence: null,
    invoice_status: 'qualified',
  ...
  // 行35: 3対3複合仕訳（N対N、決算仕訳）
  {
    ...
    labels: ['INVOICE', 'INVOICE_QUALIFIED'],
    debit_entries: [
      { account: '買掛金', account_on_document: true, sub_account: '材料費', amount: 100000, amount_on_document: true, tax_category_id: '課税仕入 10%' },
      { account: '買掛金', account_on_document: true, sub_account: '加工費', amount: 150000, amount_on_document: true, tax_category_id: '対象外' },
      { account: '買掛金', account_on_document: true, sub_account: '経費', amount: 50000, amount_on_document: true, tax_category_id: '課税仕入 10%' }
    ],
    credit_entries: [
      { account: '売掛金', account_on_document: true, sub_account: '材料費', amount: 100000, amount_on_document: true, tax_category_id: '対象外' },
      { account: '売掛金', account_on_document: true, sub_account: '加工費', amount: 150000, amount_on_document: true, tax_category_id: '対象外' },
      { account: '売掛金', account_on_document: true, sub_account: '経費', amount: 50000, amount_on_document: true, tax_category_id: '対象外' }
    ],
    rule_id: null,
    rule_confidence: null,
    invoice_status: 'qualified',
